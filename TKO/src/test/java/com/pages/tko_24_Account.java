...
public class tko_24_Account {
	public static ApplicationManager app;
	WebDriver driver;

	public tko_24_Account() {
	...
	public SelenideElement buttonPrintAccount() {
		return $(By.xpath("//span[text()='Напечатать счёт']/../..")).waitUntil(visible, app.timeOut);
	}
	public void start() {
